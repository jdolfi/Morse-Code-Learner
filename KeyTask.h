...
typedef enum
{
	...
	KEY_STATE_MACRO_ABORT		= 0x13,
	KEY_STATE_MACRO_DIT			= 0x14,
	KEY_STATE_MACRO_DAH			= 0x15,
	KEY_STATE_MACRO_DXX_GAP		= 0x16,	
	KEY_STATE_MACRO_LETTER_GAP	= 0x17,	
	KEY_STATE_MACRO_WORD_GAP	= 0x18,	
